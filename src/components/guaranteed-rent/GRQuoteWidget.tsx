        ...
        {shown && canShow && (
          <div style={{ marginTop: 4 }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
              <a href="#enquiry" style={{ display: "block", padding: "13px", background: "#0f1b36", color: "white", borderRadius: 12, fontWeight: 800, fontSize: 14, textAlign: "center", textDecoration: "none" }}>
                Book a free valuation — get my exact offer →
              </a>
              <a href="https://wa.me/4407415721628?text=Hi%2C%20I%20used%20the%20quote%20tool%20and%20I%27d%20like%20to%20discuss%20guaranteed%20rent%20for%20my%20property." target="_blank" rel="noopener noreferrer"
                style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 8, padding: "12px", background: "#22c55e", color: "white", borderRadius: 12, fontWeight: 700, fontSize: 14, textDecoration: "none" }}>
            ...
            <p style={{ fontSize: 11, color: "#94a3b8", textAlign: "center", marginTop: 10 }}>
              No obligation · We respond within 24 hours · Free property valuation
            </p>
          </div>
        )}
      </div>
