    ...
    <div className="grid lg:grid-cols-2 gap-8">
      <div className="space-y-5">
        ...
        <div>
          ...
          <input aria-label="Loan-to-Value (LTV)" type="range" min={50} max={85} step={5} value={ltv} onChange={e => setLtv(nonNegative(e.target.value))} className="w-full accent-gold-500" />
        ...
        <div>
          ...
          <input aria-label="Stress Test Rate (lenders typically use 5.0–5.5%)" type="range" min={4} max={9} step={0.25} value={stressRate} onChange={e => setStressRate(nonNegative(e.target.value))} className="w-full accent-gold-500" />
        ...
        <div>
          ...
          <input aria-label="ICR — 125% basic rate / 145% higher rate" type="range" min={100} max={170} step={5} value={icr} onChange={e => setIcr(nonNegative(e.target.value))} className="w-full accent-gold-500" />
