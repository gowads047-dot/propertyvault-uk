    ...
    <div className="grid lg:grid-cols-2 gap-8">
      <div className="space-y-5">
        ...
        <div>
          ...
          <input aria-label="Void weeks per year" type="range" min={0} max={12} step={1} value={voidWeeksPerYear} onChange={e => setVoidWeeksPerYear(nonNegative(e.target.value))} className="w-full accent-gold-500" />
        ...
        <div>
          ...
          <input aria-label="Letting Agent Fee" type="range" min={0} max={20} step={1} value={managementFee} onChange={e => setManagementFee(nonNegative(e.target.value))} className="w-full accent-gold-500" />
        ...
        <div>
          ...
          <input aria-label="Maintenance Reserve" type="range" min={0} max={15} step={1} value={maintenancePct} onChange={e => setMaintenancePct(nonNegative(e.target.value))} className="w-full accent-gold-500" />
        ...
        <div className="grid grid-cols-2 gap-3">
          <div>
            ...
            <input aria-label="Insurance" type="range" min={0} max={200} step={5} value={insurance} onChange={e => setInsurance(nonNegative(e.target.value))} className="w-full accent-gold-500" />
          ...
          <div>
            ...
            <input aria-label="Council Tax (landlord)" type="range" min={0} max={300} step={10} value={councilTax} onChange={e => setCouncilTax(nonNegative(e.target.value))} className="w-full accent-gold-500" />
          ...
          <div>
            ...
            <input aria-label="Utilities (landlord-paid)" type="range" min={0} max={400} step={10} value={utilities} onChange={e => setUtilities(nonNegative(e.target.value))} className="w-full accent-gold-500" />
          ...
          <div>
            ...
            <input aria-label="Ground Rent / Service Charge" type="range" min={0} max={4000} step={50} value={groundRent} onChange={e => setGroundRent(nonNegative(e.target.value))} className="w-full accent-gold-500" />
        ...
        <div>
          ...
          <input aria-label="Deposit Percentage" type="range" min={15} max={100} step={5} value={depositPct} onChange={e => setDepositPct(nonNegative(e.target.value))} className="w-full accent-gold-500" />
