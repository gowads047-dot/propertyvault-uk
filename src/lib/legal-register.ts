...
export const REGISTER: RegisterEntry[] = [
  ...
  { file: "src/app/blog/renters-reform-act-landlord-checklist/page.tsx", term: "prs-database", count: 3, status: "not-reviewed" },
  ...
  { file: "src/app/blog/renters-rights-act/page.tsx", term: "prs-database", count: 2, status: "not-reviewed" },
  ...
  { file: "src/app/renters-rights-act/page.tsx", term: "prs-database", count: 4, status: "not-reviewed" },
  ...
  { file: "src/app/rent-to-rent/page.tsx", term: "prs-database", count: 1, status: "not-reviewed" },
  ...
  { file: "src/app/rentura/rrb/page.tsx", term: "prs-database", count: 3, status: "not-reviewed" },
  ...
  { file: "src/app/blog/prs-ombudsman-landlord-registration/page.tsx", term: "prs-database", count: 8, status: "not-reviewed" },
