...
export const metadata: Metadata = {
  ...
  description:
    "The Renters' Rights Act 2025 for landlords and tenants: Section 21 abolition, fixed-term tenancies, rent increases, pets, the PRS Ombudsman, and what to do now.",
  keywords:
  ...
  openGraph: {
    title: "Renters' Rights Act 2025 — Complete Landlord & Tenant Guide",
    description: "The Renters' Rights Act 2025 for landlords and tenants: Section 21 abolition, fixed-term tenancies, rent increases, pets, the PRS Ombudsman, and what to do now.",
    type: "article",
