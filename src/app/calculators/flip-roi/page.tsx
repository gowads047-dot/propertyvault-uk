          ...
          <div className="grid lg:grid-cols-2 gap-8">
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div><label className="block text-xs font-semibold text-navy-700 mb-1">Holding Period (months)</label><input aria-label="Holding Period (months)" type="number" min="0" value={holdingMonths} onChange={e => setHoldingMonths(nonNegative(e.target.value))} className="w-full px-3 py-2.5 border border-navy-200 rounded-lg text-sm font-semibold focus:outline-none focus:ring-2 focus:ring-gold-400" /></div>
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div><label className="block text-xs font-semibold text-navy-700 mb-1">Legal Fees (sale)</label><div className="relative"><span className="absolute left-3 top-1/2 -translate-y-1/2 text-navy-400 text-sm">£</span><input aria-label="Legal Fees (sale)" type="number" min="0" value={saleLegalFees} onChange={e => setSaleLegalFees(nonNegative(e.target.value))} className="w-full pl-7 pr-2 py-2.5 border border-navy-200 rounded-lg text-sm font-semibold focus:outline-none focus:ring-2 focus:ring-gold-400" /></div></div>
              </div>
            </div>
