        ...
        <div className="container-max px-4">
          <div className="grid lg:grid-cols-2 gap-8">
            ...
            <div className="space-y-5">
              ...
              <h2 className="font-semibold text-navy-800 text-sm pt-2">Purchase</h2>
              <div className="grid grid-cols-2 gap-3">
                <div><label className="block text-xs font-semibold text-navy-600 mb-1">Purchase Price</label><div className="relative"><span className="absolute left-3 top-1/2 -translate-y-1/2 text-navy-400 text-sm">£</span><input aria-label="Purchase Price" type="number" min="0" value={purchasePrice} onChange={e => setPurchasePrice(nonNegative(e.target.value))} className="w-full pl-7 pr-3 py-3 border border-navy-200 rounded-xl text-sm font-semibold focus:outline-none focus:ring-2 focus:ring-gold-400" /></div></div>
                <div><label className="block text-xs font-semibold text-navy-600 mb-1">Purchase Costs (SDLT, legal)</label><div className="relative"><span className="absolute left-3 top-1/2 -translate-y-1/2 text-navy-400 text-sm">£</span><input aria-label="Purchase Costs (SDLT, legal)" type="number" min="0" value={purchaseCosts} onChange={e => setPurchaseCosts(nonNegative(e.target.value))} className="w-full pl-7 pr-3 py-3 border border-navy-200 rounded-xl text-sm font-semibold focus:outline-none focus:ring-2 focus:ring-gold-400" /></div></div>
              </div>
              <div><label className="block text-xs font-semibold text-navy-600 mb-1">Improvement Costs (not maintenance)</label><div className="relative"><span className="absolute left-3 top-1/2 -translate-y-1/2 text-navy-400 text-sm">£</span><input aria-label="Improvement Costs (not maintenance)" type="number" min="0" value={improvementCosts} onChange={e => setImprovementCosts(nonNegative(e.target.value))} className="w-full pl-7 pr-3 py-3 border border-navy-200 rounded-xl text-sm font-semibold focus:outline-none focus:ring-2 focus:ring-gold-400" /></div></div>

              <h2 className="font-semibold text-navy-800 text-sm pt-2">Sale</h2>
              <div className="grid grid-cols-2 gap-3">
                <div><label className="block text-xs font-semibold text-navy-600 mb-1">Sale Price</label><div className="relative"><span className="absolute left-3 top-1/2 -translate-y-1/2 text-navy-400 text-sm">£</span><input aria-label="Sale Price" type="number" min="0" value={salePrice} onChange={e => setSalePrice(nonNegative(e.target.value))} className="w-full pl-7 pr-3 py-3 border border-navy-200 rounded-xl text-sm font-semibold focus:outline-none focus:ring-2 focus:ring-gold-400" /></div></div>
                <div><label className="block text-xs font-semibold text-navy-600 mb-1">Sale Costs (agent, legal)</label><div className="relative"><span className="absolute left-3 top-1/2 -translate-y-1/2 text-navy-400 text-sm">£</span><input aria-label="Sale Costs (agent, legal)" type="number" min="0" value={saleCosts} onChange={e => setSaleCosts(nonNegative(e.target.value))} className="w-full pl-7 pr-3 py-3 border border-navy-200 rounded-xl text-sm font-semibold focus:outline-none focus:ring-2 focus:ring-gold-400" /></div></div>
              </div>

              {ownership === "personal" && (
                <>
                  <h2 className="font-semibold text-navy-800 text-sm pt-2">Your Tax Position</h2>
                  <div className="grid grid-cols-2 gap-3">
                    <div><label className="block text-xs font-semibold text-navy-600 mb-1">Other Annual Income</label><div className="relative"><span className="absolute left-3 top-1/2 -translate-y-1/2 text-navy-400 text-sm">£</span><input aria-label="Other Annual Income" type="number" min="0" value={otherIncome} onChange={e => setOtherIncome(nonNegative(e.target.value))} className="w-full pl-7 pr-3 py-3 border border-navy-200 rounded-xl text-sm font-semibold focus:outline-none focus:ring-2 focus:ring-gold-400" /></div></div>
                    <div><label className="block text-xs font-semibold text-navy-600 mb-1">Annual Exempt Amount</label><div className="relative"><span className="absolute left-3 top-1/2 -translate-y-1/2 text-navy-400 text-sm">£</span><input aria-label="Annual Exempt Amount" type="number" min="0" value={annualExemption} onChange={e => setAnnualExemption(nonNegative(e.target.value))} className="w-full pl-7 pr-3 py-3 border border-navy-200 rounded-xl text-sm font-semibold focus:outline-none focus:ring-2 focus:ring-gold-400" /></div></div>
                  </div>
                </>
              )}
            </div>
            ...
            <div>
              ...
              <div className="bg-white rounded-2xl border border-navy-100 p-6">
                <h3 className="font-bold text-navy-800 mb-3">Calculation Breakdown</h3>
