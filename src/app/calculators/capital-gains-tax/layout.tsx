...
export const metadata: Metadata = {
  title: "Capital Gains Tax Calculator UK 2025 — Property CGT | PropertyVault",
  ...
  keywords: "capital gains tax calculator UK property, CGT calculator 2025, property CGT calculator, CGT on house sale, 60 day CGT reporting",
  openGraph: {
    title: "Capital Gains Tax Calculator UK 2025 — Property CGT | PropertyVault",
