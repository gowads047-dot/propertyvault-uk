          ...
          <div className="grid lg:grid-cols-2 gap-8">
            <div className="space-y-5">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div><label className="block text-sm font-semibold text-navy-700 mb-1">New Rate ({newRate}%)</label><input type="range" min={1} max={10} step={0.1} value={newRate} onChange={e => setNewRate(nonNegative(e.target.value))} className="w-full accent-gold-500" /></div>
              </div>
              <div><label className="block text-sm font-semibold text-navy-700 mb-1">Remaining Term ({remainingTerm} years)</label><input type="range" min={5} max={35} step={1} value={remainingTerm} onChange={e => setRemainingTerm(nonNegative(e.target.value))} className="w-full accent-gold-500" /></div>

              <h3 className="font-bold text-navy-800 text-sm border-b border-navy-100 pb-2">Switching Costs</h3>
              <div className="grid grid-cols-2 gap-3">
                <div><label className="block text-xs font-semibold text-navy-700 mb-1">Arrangement Fee</label><div className="relative"><span className="absolute left-3 top-1/2 -translate-y-1/2 text-navy-400 text-sm">£</span><input type="number" min="0" value={arrangementFee} onChange={e => setArrangementFee(nonNegative(e.target.value))} className="w-full pl-7 pr-2 py-2 border border-navy-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-gold-400" /></div></div>
                <div><label className="block text-xs font-semibold text-navy-700 mb-1">Valuation Fee</label><div className="relative"><span className="absolute left-3 top-1/2 -translate-y-1/2 text-navy-400 text-sm">£</span><input type="number" min="0" value={valuationFee} onChange={e => setValuationFee(nonNegative(e.target.value))} className="w-full pl-7 pr-2 py-2 border border-navy-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-gold-400" /></div></div>
                <div><label className="block text-xs font-semibold text-navy-700 mb-1">Legal Fees</label><div className="relative"><span className="absolute left-3 top-1/2 -translate-y-1/2 text-navy-400 text-sm">£</span><input type="number" min="0" value={legalFees} onChange={e => setLegalFees(nonNegative(e.target.value))} className="w-full pl-7 pr-2 py-2 border border-navy-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-gold-400" /></div></div>
                <div><label className="block text-xs font-semibold text-navy-700 mb-1">Early Exit Fee</label><div className="relative"><span className="absolute left-3 top-1/2 -translate-y-1/2 text-navy-400 text-sm">£</span><input type="number" min="0" value={exitFee} onChange={e => setExitFee(nonNegative(e.target.value))} className="w-full pl-7 pr-2 py-2 border border-navy-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-gold-400" /></div></div>
              </div>
            </div>
