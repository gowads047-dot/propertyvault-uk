                        ...
                        <div style={{ display: "flex", flexWrap: "wrap", gap: 6, marginTop: 10 }}>
                          {msg.actions.map((a, i) => (
                            a.type === "log_when_done"
                              ? <button key={i} onClick={() => send(a.label)} style={{ fontSize: 11, fontWeight: 700, padding: "4px 10px", borderRadius: 20, background: `${a.color}20`, color: a.color, border: `1px solid ${a.color}60`, cursor: "pointer", fontFamily: "inherit" }}>
                                  {a.label} →
                                </button>
