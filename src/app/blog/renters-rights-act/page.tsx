...
export const metadata: Metadata = {
  ...
  description: "The Renters' Rights Act abolishes Section 21, ends fixed-term tenancies, limits rent increases and widens tenants' rights. What changed for landlords, and when.",
  ...
  openGraph: {
    ...
    images: [{ url: "https://www.propertyvaultuk.co.uk/blog/renters-rights-act/opengraph-image/", width: 1200, height: 630, alt: "UK rental property legal document and Renters Rights Act guide" }],
  },
  twitter: {
