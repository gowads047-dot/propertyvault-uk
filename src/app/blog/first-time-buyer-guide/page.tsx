...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: "https://www.propertyvaultuk.co.uk/blog/first-time-buyer-guide/opengraph-image/", width: 1200, height: 630, alt: "First-time buyer collecting house keys at front door" }],
  },
  twitter: {
