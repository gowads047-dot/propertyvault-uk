...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: "https://www.propertyvaultuk.co.uk/blog/rent-to-rent-explained/opengraph-image/", width: 1200, height: 630, alt: "Rent-to-rent property agreement and strategy guide UK" }],
  },
  twitter: {
