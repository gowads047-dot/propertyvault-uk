...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://www.propertyvaultuk.co.uk/blog/istihtmar-aqari-uk-min-kharij/opengraph-image/",
        width: 1200,
        height: 630,
      ...
      <article className="section-padding bg-white">
        <div className="container-max max-w-3xl">
          <div dir="rtl" lang="ar" className="space-y-6 text-navy-600 leading-relaxed">
            ...
            <p>
              عند بيع العقار، تدفع 18% (للشريحة الضريبية الأساسية) أو 24% (للشرائح الأعلى) على صافي الربح بعد طرح الإعفاء السنوي البالغ £3,000 لعام 2026/27. المهلة المتاحة للتصريح والسداد هي 60 يوماً فقط من إتمام البيع — التأخر يُفضي إلى غرامات.
            </p>
