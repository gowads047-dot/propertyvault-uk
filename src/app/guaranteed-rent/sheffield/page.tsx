...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: "website",
    url: "https://propertyvaultuk.co.uk/guaranteed-rent/sheffield/",
    siteName: "PropertyVault UK",
    images: [{ url: "https://propertyvaultuk.co.uk/opengraph-image", width: 1200, height: 630, alt: "Guaranteed Rent Sheffield — PropertyVault UK" }],
  },
  alternates: { canonical: "https://propertyvaultuk.co.uk/guaranteed-rent/sheffield/" },
};
...
const jsonLd = {
  ...
  availableChannel: {
    "@type": "ServiceChannel",
    serviceUrl: "https://propertyvaultuk.co.uk/guaranteed-rent/sheffield/",
  },
};
      ...
      <section className="gradient-navy relative overflow-hidden py-20 md:py-28">
        ...
        <div className="container-max px-4 relative z-10 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <a href="https://wa.me/4407415721628?text=Hi%2C%20I%27m%20a%20landlord%20in%20Sheffield%20interested%20in%20guaranteed%20rent." target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-green-500 text-white font-bold rounded-xl hover:bg-green-600 transition-all shadow-lg text-lg">
        ...
        <div className="container-max max-w-3xl">
          <FAQSchema faqs={[
            ...
            },
            {
              ...
              a: "All routine maintenance and tenant repair requests are managed by PropertyVault UK through our local Sheffield contractor network. Day-to-day issues are resolved by us at no extra cost. For major works we'll always notify you and agree the approach beforehand.",
            },
            {
