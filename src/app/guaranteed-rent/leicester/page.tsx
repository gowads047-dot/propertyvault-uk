...
export const metadata: Metadata = {
  ...
  description: "Guaranteed rent for landlords in Leicester. We lease your property for 3-5 years and pay a fixed monthly rent. No voids, no management, no fees. LE postcodes.",
  ...
  openGraph: {
    ...
    images: [{ url: "https://www.propertyvaultuk.co.uk/guaranteed-rent/leicester/opengraph-image/", width: 1200, height: 630, alt: "Guaranteed Rent Leicester — PropertyVault UK" }],
  },
      ...
      <section className="gradient-navy relative overflow-hidden py-20 md:py-28">
        ...
        <div className="container-max px-4 relative z-10 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <a href="https://wa.me/447415721628?text=Hi%2C%20I%27m%20a%20landlord%20in%20Leicester%20interested%20in%20guaranteed%20rent." target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-green-500 text-[#0b2e18] font-bold rounded-xl hover:bg-green-600 transition-all shadow-lg text-lg">
