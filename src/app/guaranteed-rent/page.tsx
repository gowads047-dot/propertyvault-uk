...
const guaranteedRentFaqs = [
  ...
  { q: "Is this the same as rent-to-rent?", a: "Structurally, yes — and you should hear that from us rather than find it out. We take a lease on your property for three to five years, pay you a fixed rent whether it is occupied or not, and place the occupier ourselves. The Property Redress Scheme describes guaranteed rent and rent-to-rent as the same arrangement, and this site's own guide to rent-to-rent defines the model in the same terms we use here: a three-to-five-year lease at 10-20% below market rent. What differs between operators is not the structure, it is who is doing it and what the lease says. That is why our lease terms are on the table before you commit to anything, why we tell you to get your mortgage lender's answer in writing first, and why we say plainly that we are a private company rather than a council or a housing association." },
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: "https://www.propertyvaultuk.co.uk/guaranteed-rent/opengraph-image/", width: 1200, height: 630, alt: "Guaranteed Rent for Landlords" }],
  },
  twitter: {
        ...
        <div className="container-max px-4 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              ...
              <a href="https://wa.me/447415721628?text=Hi%2C%20I%27m%20a%20landlord%20interested%20in%20guaranteed%20rent.%20Can%20you%20tell%20me%20more%3F" target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 px-6 py-4 bg-green-500 text-[#0b2e18] font-bold rounded-xl hover:bg-green-600 transition-all shadow-lg text-base">
        ...
        <div className="container-max max-w-2xl">
          ...
          <div className="grid sm:grid-cols-2 gap-3 mb-6">
            ...
            <a href="https://wa.me/447415721628?text=Hi%2C%20I%27m%20a%20landlord%20interested%20in%20guaranteed%20rent.%20Can%20you%20tell%20me%20more%3F" target="_blank" rel="noopener noreferrer"
              className="flex flex-col items-center gap-2 px-6 py-5 bg-green-500 text-[#0b2e18] font-bold rounded-2xl hover:bg-green-600 transition-all shadow-xl hover:-translate-y-1 text-center">
              <svg className="w-7 h-7" fill="currentColor" viewBox="0 0 24 24"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z"/></svg>
              <span className="text-base">Message on WhatsApp</span>
              <span className="text-xs text-[#0b2e18]/85 font-normal">Instant reply during business hours</span>
            </a>
          </div>
      ...
      <section className="gradient-navy py-12">
        <div className="container-max max-w-2xl text-center px-4">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            ...
            <a href="https://wa.me/447415721628?text=Hi%2C%20I%27m%20interested%20in%20guaranteed%20rent%20for%20my%20property." target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 px-6 py-4 bg-green-500 text-[#0b2e18] font-bold rounded-xl hover:bg-green-600 transition-all">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z"/></svg>
              WhatsApp
            </a>
          </div>
