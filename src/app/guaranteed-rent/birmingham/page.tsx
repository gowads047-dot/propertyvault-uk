    ...
    <>
      <section className="gradient-navy relative overflow-hidden py-20 md:py-28">
        ...
        <div className="container-max px-4 relative z-10 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <a href="https://wa.me/4407415721628?text=Hi%2C%20I%27m%20a%20landlord%20in%20Birmingham%20interested%20in%20guaranteed%20rent." target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-green-500 text-white font-bold rounded-xl hover:bg-green-600 transition-all shadow-lg text-lg">
      ...
      <section className="section-padding bg-white">
        <div className="container-max max-w-3xl">
          ...
          <p className="text-navy-600 leading-relaxed mb-6">We work with Birmingham City Council and registered social housing providers to house families and individuals in well-managed, compliant accommodation.</p>
