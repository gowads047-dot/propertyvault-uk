...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: ogImages("Guaranteed rent versus a letting agent — the full cost breakdown", "/guaranteed-rent/opengraph-image/"),
  },
};
        ...
        <div className="container-max px-4 relative z-10 max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-2 px-6 py-4 bg-green-500 text-[#0b2e18] font-bold rounded-xl hover:bg-green-600 transition-all text-base"
            >
