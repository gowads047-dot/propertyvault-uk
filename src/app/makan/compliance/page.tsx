...
const countries = [
  {
    ...
    landlordMust: [
      ...
      { req: "Deposit Protection Scheme", detail: "All deposits must be held in a government-approved scheme (TDS, DPS, or MyDeposits) within 30 days. Failure means the landlord cannot serve a Section 21 notice.", critical: true },
    ...
    tenantRights: [
      ...
      "Section 21 'no fault' eviction requires minimum 2 months' notice",
    ],
