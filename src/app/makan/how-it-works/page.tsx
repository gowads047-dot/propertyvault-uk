        ...
        <div className="h-container max-w-3xl">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            {[
              ...
              { icon: "🏦", title: "Deposit protection (UK)", desc: "UK tenants: your landlord must protect your deposit in a government-approved scheme (TDS, DPS, or MyDeposits) within 30 days of payment. If they don't, it is a criminal offence and you may be entitled to a penalty of 1–3x the deposit amount." },
