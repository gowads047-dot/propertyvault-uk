...
export default function ListingPage() {
  ...
  // No fallback: without an owner-supplied number there is nobody to contact.
  const whatsappNum = owner?.whatsapp || null;
        ...
        <div className="grid lg:grid-cols-3 gap-8 lg:gap-12">
          ...
          <div className="space-y-4">
            <div className="rounded-2xl overflow-hidden sticky top-20" style={{ border: "1px solid var(--h-border)", boxShadow: "0 4px 24px -8px rgba(0,0,0,0.08)" }}>
              ...
              <div className="p-5">
                {/* Only shown when the listing owner provided a number. */}
                {whatsappNum && (
                <a
                  ...
                  style={{ background: "#25D366", color: "#0b2e18", fontSize: "0.95rem", letterSpacing: "-0.01em" }}>
