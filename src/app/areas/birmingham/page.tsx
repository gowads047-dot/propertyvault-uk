        ...
        <div className="container-max px-4 max-w-3xl">
          <div className="bg-navy-800 rounded-2xl p-8 md:p-10 text-center">
            ...
            <div className="flex flex-wrap gap-3 justify-center">
              ...
              <a href="https://wa.me/4407415721628?text=Hi%2C%20I%20have%20a%20property%20in%20Birmingham%20and%20I%27m%20interested%20in%20guaranteed%20rent." target="_blank" rel="noopener noreferrer" className="btn-outline !border-white/20 !text-white hover:!bg-white/5 flex items-center gap-2">
