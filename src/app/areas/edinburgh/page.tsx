...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: "article",
    url: "https://propertyvaultuk.co.uk/areas/edinburgh/",
    siteName: "PropertyVault UK",
    images: [{ url: "https://propertyvaultuk.co.uk/opengraph-image", width: 1200, height: 630, alt: "Edinburgh Property Investment Guide" }],
  },
  twitter: {
