...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: "Complete Coventry property investment guide. Best areas for buy-to-let, average rental yields, house prices, regeneration zones, and free tools for investors.",
    type: "article",
    url: "https://propertyvaultuk.co.uk/areas/coventry/",
    siteName: "PropertyVault UK",
    images: [{ url: "https://propertyvaultuk.co.uk/opengraph-image", width: 1200, height: 630, alt: "Coventry Property Investment Guide" }],
  },
  twitter: {
        ...
        <div className="container-max px-4 max-w-3xl">
          <div className="bg-navy-800 rounded-2xl p-8 md:p-10 text-center">
            ...
            <div className="flex flex-wrap gap-3 justify-center">
              ...
              <a href="https://wa.me/447415721628?text=Hi%2C%20I%20have%20a%20property%20in%20Coventry%20and%20I%27m%20interested%20in%20guaranteed%20rent." target="_blank" rel="noopener noreferrer" className="btn-outline !border-white/20 !text-white hover:!bg-white/5 flex items-center gap-2">
