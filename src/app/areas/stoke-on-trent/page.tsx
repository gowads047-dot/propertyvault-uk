...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: "https://www.propertyvaultuk.co.uk/opengraph-image/", width: 1200, height: 630, alt: "Stoke-on-Trent Property Investment Guide" }],
  },
  twitter: {
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto text-center">
            <div>
              <p
                ...
                style={{ fontFamily: "var(--font-family-heading)" }}
              >
                <LiveAveragePrice area="stoke-on-trent" />
              </p>
