...
export const metadata: Metadata = {
  title: "Leicester Buy-to-Let Guide 2026 — Yields, Areas & Prices",
  ...
  openGraph: {
    ...
    images: [{ url: "https://www.propertyvaultuk.co.uk/opengraph-image/", width: 1200, height: 630, alt: "Leicester Property Investment Guide" }],
  },
  twitter: {
      ...
      <section className="bg-navy-50 py-10">
        <div className="container-max px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
            {[
              { n: <LiveAveragePrice area="leicester" />, l: "Average house price" },
