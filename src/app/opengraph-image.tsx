// Colours are literals on purpose: next/og rasterises this server-side and
// cannot read CSS custom properties. The contrast sweep of 27 Aug rewrote
// the gold here to var(--gold-ink), and from then until 18 Sept "VAULT"
// rendered black on navy in every social share. #f4d35e is --gold-ink's
// dark-ground value; keep it in step with globals.css by hand.
      ...
      <div style={{ width: 1200, height: 630, display: "flex", background: "#0c1730", position: "relative" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", justifyContent: "center", paddingLeft: 72, paddingRight: 40, flex: 1 }}>
          ...
          <div style={{ display: "flex", alignItems: "baseline", gap: 10, marginTop: -6 }}>
            <span style={{ fontSize: 90, fontWeight: 800, color: "#f4d35e", letterSpacing: "-2px", lineHeight: 1, fontFamily: "serif" }}>VAULT</span>
